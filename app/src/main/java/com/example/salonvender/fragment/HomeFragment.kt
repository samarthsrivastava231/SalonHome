...
//        list.add(Banner_Model(R.drawable.banner3))
        ...
        viewModel.getHomeData().observe(requireActivity(), Observer {
            val imageSliderAdapter = Image_Slider_Adapter(requireActivity(), it.banners)
...
//            list2.add(Manage_service_model(R.drawable.add_services, "Add Serviecs"))
            ...
            val adapter = Mange_service_Adapter(requireActivity(), it.categories)
...
//            list4.add(Top_service_Model(R.drawable.bannty, "Add Serviecs"))
            ...
            val topServiceAdapter = Top_service_Adapter(requireActivity(),it.top_services)
